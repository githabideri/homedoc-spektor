"""Shared CLI helpers for the Spektor toolkit."""
...
from .reporting import overview, per_section
from .sysprobe import collect as collect_probe
from .util import DEFAULT_TIMEOUT, safe_json_dump
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Command timeout seconds for --collect",
    )
...
def default_namespace() -> argparse.Namespace:
    """Return the CLI parser namespace with default values applied."""
